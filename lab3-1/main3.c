...
void decrease_capacity(int** arrayPtr, int*capacity_p) {
    // Calculate new size (double the old size)
    (*capacity_p) = (*capacity_p) / 2;
...
void check_fix_capacity(int*array, int* size_p, int* capacity_p) {
    ...
    if (*size_p < *capacity_p/2) {
        decrease_capacity(&array, capacity_p);
    }
    ...
    while (1) {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                insertItemAtIndex(array, size_p, position, value);
            ...
            case 3:
                ...
                removeItemAtIndex(array, size_p, position);
